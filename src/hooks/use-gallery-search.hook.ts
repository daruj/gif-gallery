...
const useGallerySearch = ({ searchAfterChars, initialSearchQuery }: UseGallerySearch) => {
    ...
    const { isLoading, data, fetchNextPage, isFetching, isSuccess, isFetched, isRefetching, isError, refetch } =
        useInfiniteQuery({
    ...
    return { onSearch, onPaginate, images, isLoading, isFetching, isSuccess, isFetched, isRefetching, isError, refetch }
}
